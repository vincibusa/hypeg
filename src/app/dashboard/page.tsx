...
export default function DashboardPage() {
  ...
  const fetchPayments = useCallback(async () => {
    try {
      ...
      const q = query(paymentsCollection, orderBy('created_at', 'desc'), orderBy('paid_at', 'desc'));
    ...
    return (
      <div className="min-h-screen bg-[var(--bg-secondary)] flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-[var(--text-secondary)]">Caricamento dashboard...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-[var(--text-secondary)] text-lg">
            Visualizza lo storico dei tuoi pagamenti e gestisci i tuoi servizi
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          >
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-medium text-[var(--text-secondary)]">Pagamenti Completati</p>
          ...
          >
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-medium text-[var(--text-secondary)]">Totale Incassi</p>
                <p className="text-2xl font-bold text-[var(--text-primary)]">
                  {formatPrice(
                    payments
          ...
          >
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-medium text-[var(--text-secondary)]">Totale Pagamenti</p>
