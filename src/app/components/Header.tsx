...
export default function Header() {
  ...
  return (
    <motion.header 
      className="bg-[var(--bg-primary)] py-4 shadow-sm sticky top-0 z-50 border-b border-[var(--border-primary)]"
    ...
    >
      <div className="container mx-auto px-6 flex justify-between items-center">
        ...
        <div className="flex items-center space-x-4">
          <motion.button 
            onClick={toggleTheme}
            className="p-2 rounded-lg bg-[var(--bg-secondary)] text-[var(--text-primary)] hover:bg-[var(--accent-primary)] hover:text-white transition duration-300"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          <motion.button 
            className="md:hidden text-[var(--text-primary)] z-10"
      ...
      <AnimatePresence>
        {isMenuOpen && (
          <motion.div
            className="md:hidden bg-[var(--bg-primary)] border-t border-[var(--border-primary)] overflow-hidden shadow-lg"
