      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <div className="flex space-x-4">
              <a href="https://facebook.com/HipeGPalermo" target="_blank" rel="noopener noreferrer" className="text-[var(--text-secondary)] hover:text-[var(--text-primary)] transition duration-300">
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v2.385z" />
                </svg>
              </a>
              <a href="https://instagram.com/hipeg_palermo" target="_blank" rel="noopener noreferrer" className="text-[var(--text-secondary)] hover:text-[var(--text-primary)] transition duration-300">
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="https://linkedin.com/company/hipeg-palermo" target="_blank" rel="noopener noreferrer" className="text-[var(--text-secondary)] hover:text-[var(--text-primary)] transition duration-300">
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M4.98 3.5c0 1.381-1.11 2.5-2.48 2.5s-2.48-1.119-2.48-2.5c0-1.38 1.11-2.5 2.48-2.5s2.48 1.12 2.48 2.5zm.02 4.5h-5v16h5v-16zm7.982 0h-4.968v16h4.969v-8.399c0-4.67 6.029-5.052 6.029 0v8.399h4.988v-10.131c0-7.88-8.922-7.593-11.018-3.714v-2.155z" />
                </svg>
              </a>
              <a href="https://twitter.com/hipeg_palermo" target="_blank" rel="noopener noreferrer" className="text-[var(--text-secondary)] hover:text-[var(--text-primary)] transition duration-300">
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="border-t border-[var(--border-primary)] mt-12 pt-8 text-center text-[var(--text-secondary)]">
          <div className="flex flex-col sm:flex-row justify-center items-center space-y-2 sm:space-y-0 sm:space-x-6 mb-4">
            <a href="/privacy" className="hover:text-[var(--text-primary)] transition duration-300">
              Privacy Policy
            </a>
            <span className="hidden sm:inline">•</span>
            <a href="/terms" className="hover:text-[var(--text-primary)] transition duration-300">
              Termini di Servizio
            </a>
            <span className="hidden sm:inline">•</span>
            <a href="/cookie-policy" className="hover:text-[var(--text-primary)] transition duration-300">
              Cookie Policy
            </a>
          </div>
          <p>&copy; 2025 HipeG Creative Company. Tutti i diritti riservati.</p>
        </div>
      </div>
    </footer>
  );
